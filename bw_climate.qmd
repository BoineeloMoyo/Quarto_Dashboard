...
### Row {height=30%}
```{r ghg global}
# Output the formatted text correctly
library(htmltools)
htmltools::HTML(paste0(
  "<div style='text-align: center;'>",
  "<p style='font-size:28px; color:#1F4E78; font-weight:bold;'>Total of: </p>",
  "<p style='font-size:34px; color:#30658E; font-weight:bold;'>0.05%</p>",
    "<p style='font-size:34px; color:#5E93B5; font-weight:bold;'>of global GHG emissions in 2021</p>",
  "</div>"
))
```