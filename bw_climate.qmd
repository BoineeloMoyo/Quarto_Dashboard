...
ghg <- ghg %>%
  ...
  rename(CO2 = CO2, N2O = N20, CH4 = CH4, `F-Gases` = F_Gas) %>%
  select(Year, CO2, N2O, CH4, `F-Gases`)  # reorder to show F-Gases last (drawn on top)
...
ghg |>
  ...
  e_river(N20, name = "N2O") |>
  e_river(CH4, name = "CH4") |>
