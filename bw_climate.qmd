...
data.frame(value = 3436) |>
  e_charts() |>
  e_gauge(value, 
          min = 840, max = 3800, 
          name = "Total Hours of Sunshine", 
          title = list(fontSize = 18, color = "#182b33"), 
          axisLine = list(
            lineStyle = list(
              width = 15, 
              color = list(
                c(0.5, "#345e67"),  # Base color
                c(1, "#9ed8d3")   # Threshold color
              )
            )
          ), 
          detail = list(
  ...
  e_title("BW Total Hours of Sunshine", left = "center", top = "10%") |> 
  e_tooltip()  # Adds a hover tooltip for extra interaction
