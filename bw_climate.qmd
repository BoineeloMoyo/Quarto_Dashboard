...
gauge_chart
```
::: {.valuebox icon="thermometer-half" color="light" style="color: #2c3f66;"}
```{r avr_temp}
htmltools::HTML(paste0(
  "<div style='text-align: center;'>",
  "<p style='font-size:28px; color:#182b33; font-weight:bold;'>Average Temperature</p>",
  "<p style='font-size:34px; color:#538586; font-weight:bold;'>", 24.5, "°C", "</p>",
  "</div>"
))
```
:::