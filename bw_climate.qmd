...
```{r heatmap}
# Read the CSV file
temps <- read.csv("data/avg_monthly_high_temps.csv", sep=",", header=TRUE, stringsAsFactors=FALSE)

# Convert District column to row names
rownames(temps) <- temps$Districts
temps$Districts <- NULL

# Melt the data into long format
temps_long <- melt(temps, variable.name="Month", value.name="Temperature")
