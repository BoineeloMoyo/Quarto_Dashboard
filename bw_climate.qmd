...
htmltools::HTML(paste0(
  ...
  "<p style='font-size:34px; color:#0a4541; font-weight:bold; font-family: Roboto;''>", 24.5, "°C", "</p>",
  "</div>"
))
```
:::
...
htmltools::HTML(paste0(
  ...
  "<p style='font-size:34px; color:#0a4541 font-weight:bold; font-family: Roboto;''>", "+", 2.1, "°C", "</p>",
  "</div>"
))
```
:::
...
htmltools::HTML(paste0(
  ...
  "<p style='font-size:34px; color:#0a4541; font-weight:bold; font-family: Roboto;''>0.05%</p>",
  "</div>"
))
```
:::
...
htmltools::HTML(paste0(
  ...
  "<p style='font-size:34px; color:#0a4541; font-weight:bold; font-family: Roboto;''>1.5%</p>",
  "</div>"
))
```
:::
